...
def evaluate(individual, num_classes, num_epochs, batch_size, learning_rate):
    ...
    structure = Network(individual.structure, [(3, 32), (32, 128), (128, 128)], num_classes, (32, 32)).to(device)
...
def test(test_loader, structure, criterion):
    ...
    with torch.no_grad():
        ...
        print('test: step[{}/{}], loss:{:.4f}, accuracy:{:.4f}'.format(step+1, total_step, total_loss / total_step, accuracy))
        return accuracy
