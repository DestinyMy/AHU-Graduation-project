...
class Individual(object):
    def __init__(self, structure=None, model=None, accuracy=0):
...
def init(num_individuals=10, num_phases=3, num_nodes=4):
    ...
    for i in range(num_individuals):
        ...
        individual.model = Network(individual.structure, [(3, 64), (64, 128), (128, 256), (256, 512)])
...
def lemonade(individuals, num_individuals, generations):
